...
@testset verbose=false "MakeEqual (UniformSolver)" begin
    ...
    @testset "MakeEqualSuccess" begin
        ...
        @test HerbConstraints.make_equal!(solver, left, right) isa
    ...
    @testset "MakeEqualSuccess, 1 VarNode" begin
        ...
        @test HerbConstraints.make_equal!(solver, node, varnode) isa
              HerbConstraints.MakeEqualSuccess
    end
    ...
    @testset "MakeEqualSuccess, 1 RuleNode and a DomainRuleNode" begin
        ...
        @test HerbConstraints.make_equal!(solver, node, domainrulenode) isa
              HerbConstraints.MakeEqualSuccess
    ...
    @testset "MakeEqualHardFail, 1 AbstractHole and a DomainRuleNode" begin
        ...
        @test HerbConstraints.make_equal!(solver, hole, domainrulenode) isa
              HerbConstraints.MakeEqualHardFail
    ...
    @testset "MakeEqualSoftFail, DomainRuleNode's with VarNodes" begin
        ...
        vardomainrulenode = DomainRuleNode(
            BitVector([0, 0, 0, 1]), [
                VarNode(:a),
                VarNode(:a)
            ])
        ...
        @test HerbConstraints.make_equal!(solver, node, vardomainrulenode) isa
              HerbConstraints.MakeEqualSoftFail
