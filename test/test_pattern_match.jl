...
@testset verbose=false "PatternMatch" begin
    ...
    @testset "PatternMatchSuccess, holes underneath a VarNode" begin
        ...
        @test pattern_match(node_2holes, VarNode(:x)) isa
    ...
    @testset "PatternMatchSuccess, holes underneath different VarNodes" begin
        ...
        @test pattern_match(node_2holes, VarNode(:x)) isa
              HerbConstraints.PatternMatchSuccess
        @test pattern_match(node_3holes, VarNode(:x)) isa
              HerbConstraints.PatternMatchSuccess
        @test pattern_match(node_4holes, VarNode(:x)) isa
              HerbConstraints.PatternMatchSuccess
    end

    @testset "PatternMatchSuccessWhenHoleAssignedTo, 1 hole with a valid domain" begin
        rn_variable_shaped_hole = RuleNode(
            4, [RuleNode(1), Hole(BitVector((1, 1, 1, 1, 1, 1)))])
        rn_fixed_shaped_hole = RuleNode(
            4, [RuleNode(1), Hole(BitVector((1, 1, 0, 0, 0, 0)))])
        rn_single_value_hole = RuleNode(
            4, [RuleNode(1), Hole(BitVector((1, 0, 0, 0, 0, 0)))])
        mn = RuleNode(4, [RuleNode(1), RuleNode(1)])
        @test pattern_match(rn_variable_shaped_hole, mn) isa
              HerbConstraints.PatternMatchSuccessWhenHoleAssignedTo
        @test pattern_match(rn_fixed_shaped_hole, mn) isa
              HerbConstraints.PatternMatchSuccessWhenHoleAssignedTo
        ...
        @test pattern_match(rn_single_value_hole, mn) isa
              HerbConstraints.PatternMatchSuccess
    ...
    @testset "PatternMatchHardFail, 1 hole with an invalid domain" begin
        rn_variable_shaped_hole = RuleNode(
            4, [RuleNode(1), Hole(BitVector((0, 1, 1, 1, 1, 1)))])
        rn_fixed_shaped_hole = RuleNode(
            4, [RuleNode(1), Hole(BitVector((0, 0, 0, 1, 1, 1)))])
        rn_single_value_hole = RuleNode(
            4, [RuleNode(1), Hole(BitVector((0, 0, 0, 0, 1, 1)))])
        mn = RuleNode(4, [RuleNode(1), RuleNode(1)])
        @test pattern_match(rn_variable_shaped_hole, mn) isa
    ...
    @testset "PatternMatchHardFail, 1 hole with a valid domain, 1 hole with an invalid domain" begin
        rn1 = RuleNode(
            4, [Hole(BitVector((1, 1, 1, 1, 1, 1))), Hole(BitVector((0, 1, 1, 1, 1, 1)))])
        rn2 = RuleNode(
            4, [Hole(BitVector((0, 1, 1, 1, 1, 1))), Hole(BitVector((1, 1, 1, 1, 1, 1)))])
        mn = RuleNode(4, [RuleNode(1), RuleNode(1)])
    ...
    @testset "PatternMatchHardFail, 2 holes with invalid domains" begin
        rn = UniformHole(BitVector((0, 0, 0, 0, 1, 1)),
            [Hole(BitVector((0, 0, 1, 1, 1, 1))), RuleNode(1)])
        mn = RuleNode(4, [RuleNode(1), RuleNode(1)])
        @test pattern_match(rn, mn) isa HerbConstraints.PatternMatchHardFail
    end

    @testset "PatternMatchHardFail, 1 uniform hole with a valid domain, 1 hole with an invalid domain" begin
        rn = UniformHole(BitVector((0, 0, 0, 1, 1, 1)),
            [Hole(BitVector((0, 0, 1, 1, 1, 1))), RuleNode(1)])
        mn = RuleNode(4, [RuleNode(1), RuleNode(1)])
        @test pattern_match(rn, mn) isa HerbConstraints.PatternMatchHardFail
    end
    ...
    @testset "PatternMatchHardFail, 1 uniform hole with an invalid domain, 1 hole with a valid domain" begin
        rn1 = UniformHole(BitVector((0, 0, 0, 0, 1, 1)),
            [Hole(BitVector((1, 1, 1, 1, 1, 1))), RuleNode(1)])
        rn2 = UniformHole(BitVector((0, 0, 0, 0, 1, 1)),
            [RuleNode(1), Hole(BitVector((1, 1, 1, 1, 1, 1)))])
        mn = RuleNode(4, [RuleNode(1), RuleNode(1)])
        @test pattern_match(rn1, mn) isa HerbConstraints.PatternMatchHardFail
        @test pattern_match(rn2, mn) isa HerbConstraints.PatternMatchHardFail
    end
    ...
    @testset "PatternMatchSoftFail, 1 uniform hole with an valid domain, 1 hole with a valid domain" begin
        rn1 = UniformHole(BitVector((0, 0, 0, 1, 1, 1)),
            [Hole(BitVector((1, 1, 1, 1, 1, 1))), RuleNode(1)])
        rn2 = UniformHole(BitVector((0, 0, 0, 1, 1, 1)),
            [RuleNode(1), Hole(BitVector((1, 1, 1, 1, 1, 1)))])
        mn = RuleNode(4, [RuleNode(1), RuleNode(1)])
    ...
    @testset "PatternMatchSoftFail, 2 holes with valid domains" begin
        rn = RuleNode(
            4, [Hole(BitVector((1, 1, 1, 1, 1, 1))), Hole(BitVector((1, 1, 1, 1, 1, 1)))])
        mn = RuleNode(4, [RuleNode(1), RuleNode(1)])
    ...
    @testset "VarNode assigned to a RuleNode" begin
        ...
        @testset "Depth2" begin
            node_success = RuleNode(4,
                [RuleNode(4, [RuleNode(1), RuleNode(1)]),
                    RuleNode(4, [RuleNode(1), RuleNode(1)])])
            node_fail = RuleNode(4,
                [RuleNode(4, [RuleNode(1), RuleNode(1)]),
